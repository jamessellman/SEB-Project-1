// THE COMMENTED OUT CODE IS MY REFACTORING TO MY MOVE SHARL FUNCTIONS WHICH DO WORK.
//HOWEVER THEY CAUSE THE GAME TO CONTINUALLY SPEED UP ON RESET OF GAME WHICH I CANNOT SOLVE
// HAVE REVERTED TO MY OLD CODE FOR PURPOSE OF SUBMISSION
...
//   removeShark(sharkRowOne.current);
//   removeShark(sharkRowTwo.current);
//   removeShark(sharkRowThree.current);
//   removeShark(sharkRowFour.current);
//   removePlayer(playerCurrentPosition);
//   // loseModel();
